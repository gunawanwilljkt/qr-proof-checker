...
Intel system is disabled. To activate:
  ...
  node /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/bin/gsd-tools.cjs
