...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude
                  → checks /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done
                  → writes to /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/hooks/
...
@/Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
