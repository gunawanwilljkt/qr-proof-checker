...
- Usage: Reference from command with `@/Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/gunawanwilljkt/Documents/dev/qr-proof-checker/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
